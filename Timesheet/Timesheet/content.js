...
setTimeout(function() {    
    ...
    debugger;
    $("#header").append("<div style='right: 0; background: #f4f4f4; color: #333; padding: 10px;font-size: 1em; box-shadow:#d2d2d2 0px 3px 1px; line-height:30px;'> <div style='margin-bottom:5px; padding-left: 15px; display: inline;" + requiredHoursStyles + "'>For today you need  : " + neededHours + " hrs to match. </div> <div style='margin-bottom:5px; padding-left: 5px; display: inline; margin-left:3px;" + presentedSortHoursStyles + "'>Total present days:" + presentDays + " , Till EOD :"+ presentedSortHours +" hours "+ presentedSortHoursText +". </div> <div style='margin-bottom:5px; padding-left: 10px; display: inline;'>Total expected hours for this month : " + requiredHours + " hrs. </div> <div style='margin-bottom:5px; padding-left: 5px; display: inline;'>Total swiped : " + totalHours + " hrs</div> <div style ='display: inline;padding-left: 15px;" + style + "'> " + hoursLabel + sortedHours + " hrs </div> <div style='margin:12px 0 0 0; padding-left: 5px;display: inline;'>From tomorrow onwords you need to log: " + laggHours + "hrs only.</div></div>")
